...
if(DUCKDB_PLATFORM STREQUAL "wasm_threads" OR DUCKDB_PLATFORM STREQUAL "wasm64_threads")
  set(USE_WASM_THREADS TRUE)
endif()

set(DUCKDB_WASM_MEMORY_FLAGS "")
if(WASM_MEMORY64)
  set(DUCKDB_WASM_MEMORY_FLAGS "-sMEMORY64=1")
endif()
...
ExternalProject_Add(
  ...
  CMAKE_ARGS -G${CMAKE_GENERATOR}
             ...
             -DWASM_MEMORY_FLAGS=${DUCKDB_WASM_MEMORY_FLAGS}
