addToLibrary({
...
#if MEMORY64
    duckdb_web_fs_file_write__sig: 'ppppj',
#else
    duckdb_web_fs_file_write__sig: 'ppppd',
#endif
    ...
    duckdb_web_fs_file_get_last_modified_time__sig: 'dp',
