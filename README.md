...
DuckDB-Wasm is currently based on DuckDB v1.5.4.
...
* **WASM64 (64-bit Memory) support** is available as an opt-in feature, lifting the 4 GB memory ceiling. See the [package README](./packages/duckdb-wasm/README.md) for details.
